...
public abstract class JavaFXTest {
    ...
    public static class ApplicationHelper extends Application {
        ...
        public static void startApplication() {
            System.out.println("Hello im in startapplication of javafxtest");
        ...
        @Override public void start(Stage primaryStage) throws Exception {
            System.out.println("Hello im in start of Javafxtest");
            this.primaryStage = primaryStage;
            JavaFXTest.applicationHelper = this;
        }

        public Stage getPrimaryStage() {
            System.out.println("Hello im in Stage getPrimaryStage  of Javafxtest");
            return primaryStage;
        }

        public void startGUI(final JavaFXTest test) {
            System.out.println("Hello im in startGui of javafxtest");
